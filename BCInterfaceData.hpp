...
enum BCBaseList{ function, functionFile, OPERfunction, OPERfunctionFile, FSI };
...
public:
	 ...
	 * \param Oper - Operator
	 */
	void SetOperator( const boost::shared_ptr<Operator>& Oper) { M_operator = Oper; }
	 ...
	 */
	void SetBase( const std::pair<std::string, BCBaseList> base ) 	{ M_base = base; }
	...
	const boost::shared_ptr<Operator>& 			GetOperator()		const { return M_operator; }

	//! Get the name of the boundary condition
	const BCName& 								GetName() 			const { return M_name; }

	//! Get the flag of the boundary condition
	const BCFlag& 								GetFlag() 			const { return M_flag; }

	//! Get the type of the boundary condition
	const BCType& 								GetType() 			const { return M_type; }

	//! Get the mode of the boundary condition
	const BCMode& 								GetMode() 			const { return M_mode; }

	//! Get the vector of components of the boundary condition
	const BCComV& 								GetComV() 			const { return M_comV; }

	//! Get the number of components of the boundary condition
	const ID& 									GetComN() 			const { return M_comV.front(); }

	//! Get the base string of the boundary condition
	const std::string& 							GetBaseString()		const { return M_baseString; }

	//! Get the base type of the boundary condition
	const std::pair<std::string, BCBaseList>&	GetBase()			const { return M_base; }
...
template <class Operator>
inline void
BCInterfaceData<Operator>::ReadBC( const BCName& name, const std::string& dataSection, const GetPot& dataFile )
{
	M_name = name;
...
template <class Operator>
inline void
BCInterfaceData<Operator>::ReadFlag( const char* flag, const GetPot& dataFile )
{
...
template <class Operator>
inline void
BCInterfaceData<Operator>::ReadType( const char* type, const GetPot& dataFile )
{
...
template <class Operator>
inline void
BCInterfaceData<Operator>::ReadMode( const char* mode, const GetPot& dataFile )
{
...
template <class Operator>
inline void
BCInterfaceData<Operator>::ReadComV( const char* component, const GetPot& dataFile )
{
...
template <class Operator>
inline void
BCInterfaceData<Operator>::ReadBase( const std::string& base, const GetPot& dataFile )
{
...
template <class Operator>
inline bool
BCInterfaceData<Operator>::IsBase( const char* base, const GetPot& dataFile )
{
