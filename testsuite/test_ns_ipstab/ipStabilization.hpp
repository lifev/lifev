...
void IPStabilization<MESH, DOF>::apply( MATRIX& matrix, const VECTOR& state )
{
          ...
          ++iFace )
    {
        ...
        if ( M_gammaDiv != 0 || M_gammaBeta != 0 )
        {
            ...
            M_elMatU.zero();
            //ipstab_grad( coeffDiv, M_elMatU, M_fe1, M_fe1, M_feBd, 0, 0,
            //nDimensions );
            ...
            M_elMatU.zero();
            //ipstab_grad( coeffDiv, M_elMatU, M_fe2, M_fe2, M_feBd, 0, 0,
            //nDimensions );
            ...
            M_elMatU.zero();
            //ipstab_grad( -coeffDiv, M_elMatU, M_fe1, M_fe2, M_feBd, 0, 0,
            //             nDimensions );
            ...
            M_elMatU.zero();
            //ipstab_grad( -coeffDiv, M_elMatU, M_fe2, M_fe1, M_feBd, 0, 0,
            //             nDimensions );
