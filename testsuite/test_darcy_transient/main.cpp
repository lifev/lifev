...
Simple transient Darcy test with Dirichlet, Neumann and Robin boundary conditions
...
makeAbout()
{
    LifeV::AboutData about( "Test Darcy transient" ,
                            "LifeV Test Darcy" ,
                            "1.0",
                            "Darcy test case",
...
int main(int argc, char** argv)
{
    ...
    LifeV::Real error(0);
    // Error known
    const LifeV::Real errorKnown( 0.200301766140701 );
