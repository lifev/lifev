#ifndef __CTRK_USER_CASE_HH
#define __CTRK_USER_CASE_HH 1

#include <ctRKBaseCase.hpp>

using namespace LifeV;

/*!
 * \struct CTRKcaseUser
 * \brief User defined case study. This is the (a priori only) piece of code
 * to modify to account for possible case studies.
 */
