 ...
 * \brief LifeV MultiScale Physical Data Container
 *
...
public:
	...
	const Real& 				GetFluidDensity() 	const { return M_fluidDensity; }

	//! Get the global fluid viscosity
	const Real& 				GetFluidViscosity() const { return M_fluidViscosity; }
