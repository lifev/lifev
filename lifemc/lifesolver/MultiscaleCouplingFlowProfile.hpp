...
/*!
 *  @file
 *  @brief File containing the Multiscale Coupling FlowRate with prescribed profile
 *
 *  @date 06-09-2011
...
#ifndef MultiscaleCouplingFlowProfile_H
#define MultiscaleCouplingFlowProfile_H 1
...
//! MultiscaleCouplingFlowProfile - FlowRate coupling condition with prescribed profile
/*!
 *  @author Toni Lassila
 *
 ...
 */
class MultiscaleCouplingFlowProfile: public virtual multiscaleCoupling_Type
{
public:
    ...
    //! Constructor
    explicit MultiscaleCouplingFlowProfile();

    //! Destructor
    virtual ~MultiscaleCouplingFlowProfile() {}
...
private:
    ...
    MultiscaleCouplingFlowProfile( const MultiscaleCouplingFlowProfile& coupling );

    MultiscaleCouplingFlowProfile& operator=( const MultiscaleCouplingFlowProfile& coupling );

    //@}
};

//! Factory create function
inline multiscaleCoupling_Type* createMultiscaleCouplingFlowProfile()
{
    return new MultiscaleCouplingFlowProfile();
}

} // Namespace Multiscale
} // Namespace LifeV

#endif /* MultiscaleCouplingFlowProfile_H */
