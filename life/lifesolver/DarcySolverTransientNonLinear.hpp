...
template < typename MeshType,
           ...
           typename TraitsType = SolverTraits < MeshType, SolverType > >
class DarcySolverTransientNonLinear
        :
        public DarcySolverNonLinear < MeshType, SolverType, TraitsType >,
        public DarcySolverTransient < MeshType, SolverType, TraitsType >
{
...
public:
    ...
    //! Typedef for the class traits.
    typedef TraitsType traits_Type;

    //! Self typedef.
    typedef DarcySolverTransientNonLinear < mesh_Type, solver_Type, traits_Type > darcySolverTransientNonLinear_Type;

    //! Darcy solver class.
    typedef DarcySolverLinear < mesh_Type, solver_Type, traits_Type > darcySolverLinear_Type;

    //! Darcy non linear solver class.
    typedef DarcySolverNonLinear < mesh_Type, solver_Type, traits_Type > darcySolverNonLinear_Type;

    //! Darcy transient solver class.
    typedef DarcySolverTransient < mesh_Type, solver_Type, traits_Type > darcySolverTransient_Type;
    ...
    */
    void setInversePermeability ( const typename traits_Type::matrixFctPtr_Type& invPerm )
    {
...
protected:
    ...
    */
    virtual void localMatrixComputation ( const UInt & iElem,
                                          typename traits_Type::matrixElemental_Type& elmatMix,
                                          typename traits_Type::matrixElemental_Type& elmatReactionTerm )
    {
...
template < typename MeshType, typename SolverType, typename TraitsType >
DarcySolverTransientNonLinear < MeshType, SolverType, TraitsType >::
DarcySolverTransientNonLinear ():
