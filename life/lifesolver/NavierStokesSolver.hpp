...
//    typedef SolverType                    solver_type;
    ...
    */
    NavierStokesSolver( const data_type&     dataType,
...
void
NavierStokesSolver<Mesh, SolverType>::eval( Vector& fx0, Vector& /* gx0 */, Vector /* x0 */, int /* status */ )
{
    iterate( 0.0 );
...
template<typename Mesh, typename SolverType>
NavierStokesSolver<Mesh, SolverType>::
NavierStokesSolver( const data_type&     dataType,
                    const EpetraMap&     localMap,
                    FESpace<Mesh>&       uFESpace,
                    FESpace<Mesh>&       pFESpace,
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::setUp( const GetPot& dataFile )
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::buildSystem()
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::
updateSystem()
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::iterate( const Real& time )
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::initialize( const Function& x0,
                                                       Real            t0,
                                                       Real            dt )
{
...
template<typename Mesh, typename SolverType>
void
NavierStokesSolver<Mesh, SolverType>::initialize( const std::string & vname )
{
...
template<typename Mesh, typename SolverType>
void
NavierStokesSolver<Mesh, SolverType>::initializeNull()
{
...
template<typename Mesh, typename SolverType>
void
NavierStokesSolver<Mesh, SolverType>::initializeStokes( source_type const& source,
                                                        Real t0 )
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::solveSystem()
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::removeMean( vector_type& x, UInt comp )
{
    Real sum1 = 0.;
    Real sum0 = 0.;
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::applyBoundaryConditions(matrix_type &_csr)
{
    M_rhsFull = M_rhsNoBC;
...
template <typename Mesh, typename SolverType>
void
NavierStokesSolver<Mesh, SolverType>::postProcess()
{
...
template<typename Mesh, typename SolverType>
void NavierStokesSolver<Mesh, SolverType>::echo(std::string message)
{
