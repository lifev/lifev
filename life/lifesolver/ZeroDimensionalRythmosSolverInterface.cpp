...
void
RythmosSolverInterface::initialize()
{
...
RythmosSolverInterface::get_x_map() const
{
  return M_epetraMapPtr;
}

Teuchos::RCP<const Epetra_Map>
RythmosSolverInterface::get_f_map() const
{
  return M_epetraMapPtr;
}

Teuchos::RCP<const Epetra_Vector>
RythmosSolverInterface::get_x_init() const
{
...
Teuchos::RCP<const Epetra_Vector>
RythmosSolverInterface::get_x_dot_init() const
{
...
RythmosSolverInterface::create_W() const
{
  Teuchos::RCP<Epetra_Operator> W   = Teuchos::rcp(new Epetra_CrsMatrix(::Copy,*M_Wgraph));
  return W;
}

EpetraExt::ModelEvaluator::InArgs
RythmosSolverInterface::createInArgs() const
{
  InArgsSetup inArgs;
...
RythmosSolverInterface::createOutArgs() const
{
...
void RythmosSolverInterface::evalModel( const InArgs& inArgs, const OutArgs& outArgs ) const
{
