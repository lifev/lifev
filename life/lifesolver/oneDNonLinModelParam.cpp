...
pressure(const Real& _A, const Real& _A_n, const Real& _A_nm1, const Real& dt,
         const UInt& indz, const UInt& steps, const bool& visco, const bool& linearized ) const
{
    Vector _a(2), _b(2), _c(2), area(2), result(4);
    _a(0) = 1.; _b(0) = -1.; _c(0) = 0.;
    _a(1) = 3./2.; _b(1) = -2.; _c(1) = 1./2.;
    area(0) = _A; area(1) = _M_Area0[indz];
