...
//#include <life/lifefem/oneDBcLeft.hpp>
//#include <life/lifefem/oneDBcRight.hpp>
...
public:
    ...
    */
    ...
    const ScalUnknown<Vector>& W1_thistime() const { return _M_W1_thistime;}

    //! return the reimann invarant W2 at current time step
    const ScalUnknown<Vector>& W2_thistime() const { return _M_W2_thistime;}
    ...
    OneDBCHandler& bcH() { return _M_bcH;}

	// adds function fun for boundary condition
    //    void setBC( OneDBCFunctionPointer fun, std::string const& border, std::string const& line, std::string const& var );
    ...
    */
    ...
    void output_to_plotmtv(std::string fname, Real time_val,
                           ...
                           std::string vname );
    //! store solutions on matlab files
    ...
    void create_movie_file(int i=1);
...
private:
    ...
    */
    ...
    ScalUnknown<Vector> _M_W1_thistime;
    ScalUnknown<Vector> _M_W2_thistime;

    //! Unknown at previous time step (see savesol() )
    ScalUnknown<Vector> _M_U1_timestep;
    ScalUnknown<Vector> _M_U2_timestep;
