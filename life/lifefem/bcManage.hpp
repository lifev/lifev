...
/*!
  \file bcManage.h
  \brief Functions for imposing boundary conditions.
  \version 1.0
                      ...
                      UInt offset )
{
    ...
    /*
      ...
      Goal : to remain consistent with the functional part,
      and assume that the BCvector is a velocity (= a normal
      derivative and not a flux an integrated normal derivative).
      In the functional case, it is a velocity that is considered.
