...
StaticBdFE::StaticBdFE( const RefFE& refFE, const GeoMap& geoMap,
        ...
        M_point     ( nbGeoNode, nbCoor + 1 ),
        refFE     ( refFE ),
        geoMap    ( geoMap ), qr( qr ),
        M_phi       ( ( int ) nbNode,( int ) nbQuadPt ),
        M_dPhiRef   ( ( int ) nbNode, ( int ) nbCoor,( int ) nbQuadPt ),
        M_dPhi      ( ( int ) nbNode, ( int ) nbCoor, ( int ) nbQuadPt ),
        M_phiGeo    ( ( int ) nbGeoNode, ( int ) nbQuadPt ),
        M_dPhiGeo   ( ( int ) nbGeoNode, ( int ) nbCoor, ( int ) nbQuadPt ),
        M_weightMeas( ( int ) nbQuadPt ),
        M_meas    ( ( int ) nbQuadPt ),
        M_normal    ( ( int ) nbCoor + 1, ( int ) nbQuadPt ),
        M_tangent   ( ( int ) nbCoor, ( int ) nbCoor + 1, ( int ) nbQuadPt ),
        M_metric    ( ( int ) nbCoor, ( int ) nbCoor, ( int ) nbQuadPt ),
        M_quadPt    ( ( int ) nbQuadPt, 3 ),
        invArea   ( 1. )
{
