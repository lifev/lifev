...
private:
     ...
     */
    template <typename MeshType>
    void updateFacetConnections( const MeshType& mesh1, const entityFlag_Type& flag1,
                                 const MeshType& mesh2, const entityFlag_Type& flag2, const Real& tol, const fct& coupled );
...
template <typename MeshType>
void DOFInterface3Dto3D::updateFacetConnections( const MeshType& mesh1, const entityFlag_Type& flag1,
                                                 const MeshType& mesh2, const entityFlag_Type& flag2, const Real& tol, const fct& coupled )
{
