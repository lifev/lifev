...
/*!
 *  @file
 *  @brief File implementing the Newton method.
 *
 *  @date 00-00-0000
    ...
    while ( normRes > stop_tol && iter < maxit )
    {
        ...
        */
        ...
        case 0: // no linesearch
            ...
            break;
        case 1:
            LineSearchParabolic( f, norm, residual, sol, step, normRes, lambda, iter );
            break;
        case 2:  // recommended
            LineSearchCubic( f, norm, residual, sol, step, normRes, lambda, slope, iter );
            break;
        default:
