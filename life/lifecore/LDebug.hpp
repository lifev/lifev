...
public:
    ...
    {}
    LNDebugStream& operator<<( char const* )
    {
        return * this;
    }
    LNDebugStream& operator<<( std::string const& )
    {
        return * this;
    }
    LNDebugStream& operator<<( double )
    {
        return * this;
    }
    LNDebugStream& operator<<( LNManipFunction f )
    {
        return * this;
    }
    //@}
...
inline LNDebugStream& perror( LNDebugStream& s )
{
    return s;
}
inline LNDebugStream& endl( LNDebugStream& s )
{
    return s;
}
inline LNDebugStream& flush( LNDebugStream& s )
{
    return s;
}
...
inline LNDebugStream LNDebug( int = 0, LNDebugStream::stprintf = &printf )
{
    return LNDebugStream();
}
inline LNDebugStream LNDebug( bool cond, int = 0, LNDebugStream::stprintf = &printf )
{
    return LNDebugStream();
}
#endif
