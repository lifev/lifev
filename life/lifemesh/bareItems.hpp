...
/*!
	...
	association between local (element-wise) and global numbering, I need to
	identify edges and give them a unique ID. Yet, I may not want want to
	build a full Edge (GeoElement2D) object: after all that I need is
