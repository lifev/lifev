...
\
     ...
     *  @param flag Flags
     */
    void extractEntityList(std::vector<UInt> & list, ReferenceGeometry const & r, EntityFlag const & flag) const;
...
(std::vector<UInt> & list, ReferenceGeometry const & geometry, EntityFlag const & flag) const
{
    switch (geometry)
    {
    case VERTEX:
