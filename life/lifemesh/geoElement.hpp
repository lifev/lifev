...
class GeoElement1D : public GeoND<GEOSHAPE,GeoElement0D<MC> >, public MC::EdgeMarker
{
 public:
  ...
  ID ad_second()const {return esecond;};
  //! ID of first adjacent 2D element
  ID & ad_first(){return efirst;}
  //! ID of second adjacent 2D element
  ID & ad_second(){return esecond;}
  //! Position of first adjacent 2D element
  ID pos_first()const {return posfirst;};
  //! Position of second adjacent 2D element
  ID pos_second()const {return possecond;};
  //! Position of fist adjacent 2D element
  ID & pos_first(){return posfirst;}
  //! Position of second adjacent 2D element
  ID & pos_second(){return possecond;}
 private:
  ID efirst;
  ID esecond;
  ID posfirst;
