...
SetFlagAccordingToWatermarks::SetFlagAccordingToWatermarks
...
//========================================================
void
SetFlagAccordingToMarkerRanges::insert(rangeID_Type const & key, flag_Type flag)
 {
     M_map[key]=flag;
 }

std::pair<flag_Type,bool>
SetFlagAccordingToMarkerRanges::findFlag( markerID_Type const & m)const
                                                 {
     if(!M_map.empty())
     {
