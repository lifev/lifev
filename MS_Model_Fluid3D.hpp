...
public:
    ...
    fluidBC_type&		GetBCInterface	( void )							{ return *M_fluidBC; }

	//! Get the area on a specific boundary face of the model
	/*!
	 * \param flag - flag of the boundary face
	 */
    Real				GetArea			( const BCFlag& flag )		const	{ return M_fluid->area( flag ); }

	//! Get the flux on a specific boundary face of the model
	/*!
	 * \param flag - flag of the boundary face
	 */
    Real				GetFlux			( const BCFlag& flag )		const	{ return M_fluid->flux( flag ); }

	//! Get the pressure on a specific boundary face of the model
	/*!
	 * \param flag - flag of the boundary face
	 */
    Real				GetPressure		( const BCFlag& flag )		const	{ return M_fluid->pressure( flag ); }

	//! Get the density on a specific boundary face of the model
	/*!
	 * \param flag - flag of the boundary face
	 */
    Real				GetDensity		( const BCFlag& /*flag*/ )	const	{ return M_fluidData->density(); }

	//! Get the viscosity on a specific boundary face of the model
	/*!
	 * \param flag - flag of the boundary face
	 */
    Real				GetViscosity	( const BCFlag& /*flag*/ )	const	{ return M_fluidData->viscosity(); }
