...
class GeoND {
 public:
  ...
  void setPoint(UInt const identity, PointType  const & point); //put point 
  bool setPointWithBoundaryCheck( ID const identity, PointType const & point ); //with forced bound check
