...
for instance, if you want to compile the Trilinos library in debug mode using OpenMPI. You can also
set whatever name you feel confortable with instead of \verb!debug-openmpi!. Now go to the Trilinos source directory and start configuring :
