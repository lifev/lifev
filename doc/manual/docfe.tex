...
\subsection{HOWTO add new basis functions}
...
\subsection{HOWTO add a new quadrature rule}
...
\subsection{HOWTO add a new element operator}
...
\subsection{HOWTO build a new finite element}
