...
using \ixs{CVS}{versioning}\footnote{CVS
...
\item \verb!g++-3.x x>=2!\ixns{g++}{compilers}
\item \verb!aztec!\ixns{aztec}{algebra} (which depends on \verb!blas! and \verb!lapack!)
\end{itemize} 
