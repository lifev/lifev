...
#ifndef BCInterfaceFunctionUserDefinedSolid3D_H
#define BCInterfaceFunctionUserDefinedSolid3D_H 1
...
template< >
void
BCInterfaceFunctionUserDefined< BCHandler, StructuralOperator<RegionMesh <LinearTetra> > >::assignFunction ( bcBase_Type& base );
