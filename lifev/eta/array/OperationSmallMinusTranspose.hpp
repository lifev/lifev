...
#ifndef OPERATION_SMALL_MINUSTRANSPOSE_HPP
#define OPERATION_SMALL_MINUSTRANSPOSE_HPP
...
class OperationSmallMinusTranspose< MatrixSmall<Dim1, Dim2> >
{
public:
