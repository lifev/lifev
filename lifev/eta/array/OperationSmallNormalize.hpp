...
#ifndef OPERATION_SMALL_NORMALIZE_HPP
#define OPERATION_SMALL_NORMALIZE_HPP
...
template <>
class OperationSmallNormalize<Real >
{
public:
...
template <UInt Dim1>
class OperationSmallNormalize< VectorSmall<Dim1> >
{
public:
...
class OperationSmallNormalize< MatrixSmall<Dim1, Dim2> >
{
public:
