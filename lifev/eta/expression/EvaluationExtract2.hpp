...
/*!
 *   @file
     @brief This file contains the definition of the EvaluationExtract2 class.

     @date 06/2011
     @author Samuel Quinodoz <samuel.quinodoz@epfl.ch>
 */

#ifndef EVALUTATION_EXTRACT2_HPP
#define EVALUTATION_EXTRACT2_HPP
...
public:
    ...
    typedef typename OperationSmallExtract2< typename EvaluationType::return_Type >::result_Type return_Type;
