...
#ifndef EXPRESSION_INVERSE_HPP
#define EXPRESSION_INVERSE_HPP
...
class ExpressionInverse : public ExpressionBase< ExpressionInverse<ExpressionType> >
{
public:
    ...
    typedef ExpressionBase< ExpressionInverse <ExpressionType> > base_Type;
    ...
    //! Full constructor
    ExpressionInverse (const ExpressionType& expr)
        : base_Type(), M_expr (expr) {}

    //! Copy constructor
    ExpressionInverse (const ExpressionInverse<ExpressionType>& expression)
...
/*!
  ...
  <i>ExpressionType</i>: Same as in LifeV::ExpressionInverse

*/
template< typename ExpressionType >
ExpressionInverse<ExpressionType>
inv (const ExpressionBase<ExpressionType>& expr)
{
    return ExpressionInverse<ExpressionType> (expr.cast() );
}


// Specialization for the matricial constants
template< UInt Dim1, UInt Dim2>
ExpressionInverse<ExpressionMatrix<Dim1, Dim2> >
inv (const MatrixSmall<Dim1, Dim2>& m)
{
    return ExpressionInverse<ExpressionMatrix<Dim1, Dim2> > (ExpressionMatrix<Dim1, Dim2> (m) );
}
