...
#ifndef EVALUTATION_PRODUCT_HPP
#define EVALUTATION_PRODUCT_HPP

#include <lifev/core/LifeV.hpp>

#include <lifev/eta/array/OperationSmallProduct.hpp>
...
public:
	...
	typedef typename OperationSmallProduct<Lreturn_Type,Rreturn_Type>::result_Type return_Type;
	...
	//! Copy constructor
	EvaluationProduct(const EvaluationProduct& eval)
	...
	explicit EvaluationProduct(const ExpressionProduct<L,R>& expression)
...
template< typename EvaluationLType, typename EvaluationRType>
const flag_Type EvaluationProduct<EvaluationLType,EvaluationRType>::S_globalUpdateFlag
 = EvaluationLType::S_globalUpdateFlag | EvaluationRType::S_globalUpdateFlag;

template< typename EvaluationLType, typename EvaluationRType>
const flag_Type EvaluationProduct<EvaluationLType,EvaluationRType>::S_testUpdateFlag
 = EvaluationLType::S_testUpdateFlag | EvaluationRType::S_testUpdateFlag;

template< typename EvaluationLType, typename EvaluationRType>
const flag_Type EvaluationProduct<EvaluationLType,EvaluationRType>::S_solutionUpdateFlag
