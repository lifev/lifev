...
#ifndef EVALUTATION_CUBICROOT_HPP
#define EVALUTATION_CUBICROOT_HPP

#include <lifev/core/LifeV.hpp>
#include <cmath>
#include <lifev/eta/array/OperationSmallCubicRoot.hpp>
...
public:
    ...
    typedef typename OperationSmallCubicRoot<BaseReturn_Type>::result_Type return_Type;
    //@}
    ...
    //! Copy constructor
    EvaluationCubicRoot (const EvaluationCubicRoot& eval)
        : M_evaluationBase (eval.M_evaluationBase)
    {}

    //! Constructor from the corresponding expression
    template <typename BaseExpressionType>
    explicit EvaluationCubicRoot (const ExpressionCubicRoot<BaseExpressionType>& expression)
    ...
    {
        return cbrt (M_evaluationBase.value_q (q));
    }

    //! Getter for the value for a vector
    return_Type value_qi (const UInt& q, const UInt& i) const
    {
        return cbrt (M_evaluationBase.value_qi (q, i));
    }

    //! Getter for the value for a matrix
    return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
    {
        return cbrt (M_evaluationBase.value_qij (q, i, j) );
    }
...
template< typename EvaluationBaseType>
const flag_Type EvaluationCubicRoot<EvaluationBaseType>::S_globalUpdateFlag
    = EvaluationBaseType::S_globalUpdateFlag;

template< typename EvaluationBaseType>
const flag_Type EvaluationCubicRoot<EvaluationBaseType>::S_testUpdateFlag
    = EvaluationBaseType::S_testUpdateFlag;

template< typename EvaluationBaseType>
const flag_Type EvaluationCubicRoot<EvaluationBaseType>::S_solutionUpdateFlag
...
public:
    ...
    //! Type of the value returned by this class
    typedef typename OperationSmallIsochoricChangeOfVariable<BaseReturn_Type>::result_Type return_Type;
    //@}
    ...
    //! Constructor from the corresponding expression
    template <typename BaseExpressionType>
    explicit EvaluationIsochoricChangeOfVariable (const ExpressionIsochoricChangeOfVariable<BaseExpressionType>& expression)
        : M_evaluationBase (expression.base() )
    {}
    ...
    return_Type value_q (const UInt& q) const
    {
      return ( 1.0 / cbrt (M_evaluationBase.value_q (q)) ) * ( 1.0 / cbrt (M_evaluationBase.value_q (q)) );
    }

    //! Getter for the value for a vector
    return_Type value_qi (const UInt& q, const UInt& i) const
    {
      return ( 1.0 / cbrt (M_evaluationBase.value_qi (q, i) ) ) * ( 1.0 / cbrt (M_evaluationBase.value_qi (q, i) ) );
    }

    //! Getter for the value for a matrix
    return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
    {
      return ( 1.0 / cbrt (M_evaluationBase.value_qij (q, i, j) ) ) * ( 1.0 / cbrt (M_evaluationBase.value_qij (q, i, j) ) );
    }
...
template< typename EvaluationBaseType>
const flag_Type EvaluationIsochoricChangeOfVariable<EvaluationBaseType>::S_globalUpdateFlag
    = EvaluationBaseType::S_globalUpdateFlag;

template< typename EvaluationBaseType>
const flag_Type EvaluationIsochoricChangeOfVariable<EvaluationBaseType>::S_testUpdateFlag
    = EvaluationBaseType::S_testUpdateFlag;

template< typename EvaluationBaseType>
const flag_Type EvaluationIsochoricChangeOfVariable<EvaluationBaseType>::S_solutionUpdateFlag
    = EvaluationBaseType::S_solutionUpdateFlag;
