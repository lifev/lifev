...
#ifndef EVALUTATION_INVERSE_HPP
#define EVALUTATION_INVERSE_HPP


#include <lifev/core/LifeV.hpp>

#include <lifev/eta/array/OperationSmallInverse.hpp>
...
public:
    ...
    typedef typename OperationSmallInverse< typename EvaluationType::return_Type >::result_Type return_Type;
    ...
    //! Copy constructor
    EvaluationInverse (const EvaluationInverse& eval)
        : M_evaluation (eval.M_evaluation)
    {}

    //! Constructor from the corresponding expression
    template< typename Expression>
    explicit EvaluationInverse (const ExpressionInverse<Expression>& expression)
    ...
    {
        return M_evaluation.value_q (q).inverse();
    }

    //! Getter for the value for a vector
    return_Type value_qi (const UInt& q, const UInt& i) const
    {
        return M_evaluation.value_qi (q, i).inverse();
    }

    //! Getter for the value for a matrix
    return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
    {
        return M_evaluation.value_qij (q, i, j).inverse();
    }
...
template< typename EvaluationType >
const flag_Type EvaluationInverse<EvaluationType>::S_globalUpdateFlag
    = EvaluationType::S_globalUpdateFlag;

template< typename EvaluationType >
const flag_Type EvaluationInverse<EvaluationType>::S_testUpdateFlag
    = EvaluationType::S_testUpdateFlag;

template< typename EvaluationType >
const flag_Type EvaluationInverse<EvaluationType>::S_solutionUpdateFlag
