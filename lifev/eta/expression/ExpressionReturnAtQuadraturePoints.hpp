...
#ifndef EXPRESSION_RETURN_AT_QUAD_PTS_HPP
#define EXPRESSION_RETURN_AT_QUAD_PTS_HPP
...
{
    return ExpressionReturnAtQuadraturePoints<MeshType, MapType, SpaceDim, FieldDim> (fespace, vector);
}
