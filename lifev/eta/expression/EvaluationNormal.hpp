...
/*!
    @file
    @brief This file contains the definition of the evaluation for the normal

    @author Samuel Quinodoz <samuel.quinodoz@epfl.ch>
    @date 03 Jan 2012
 */

#ifndef EVALUATION_NORMAL_HPP
#define EVALUATION_NORMAL_HPP
...
//! EvaluationNormal - Evaluation of the normal
/*!
...
public:
    ...
    //! Copy constructor
    EvaluationNormal (const EvaluationNormal<spaceDim>& evaluation)
        : M_valuePtr (evaluation.M_valuePtr)
    {}

    //! Expression-based constructor
    explicit EvaluationNormal (const ExpressionNormal& /*expression*/) {}
...
template<UInt spaceDim>
const flag_Type EvaluationNormal<spaceDim>::S_globalUpdateFlag = ET_UPDATE_NONE;

template<UInt spaceDim>
const flag_Type EvaluationNormal<spaceDim>::S_testUpdateFlag = ET_UPDATE_NONE;

template<UInt spaceDim>
const flag_Type EvaluationNormal<spaceDim>::S_solutionUpdateFlag = ET_UPDATE_NONE;
