...
#ifndef EXPRESSION_NORMALIZE_HPP
#define EXPRESSION_NORMALIZE_HPP
...
class ExpressionNormalize : public ExpressionBase< ExpressionNormalize<ExpressionType> >
{
public:
...
/*!
  ...
  <i>ExpressionType</i>: Same as in LifeV::ExpressionNormalize

*/
template< typename ExpressionType >
ExpressionNormalize<ExpressionType>
normalize (const ExpressionBase<ExpressionType>& expr)
{
    return ExpressionNormalize<ExpressionType> (expr.cast() );
}
