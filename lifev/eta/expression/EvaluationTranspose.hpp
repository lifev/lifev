...
#include <lifev/eta/array/OperationSmallTranspose.hpp>
...
public:
    ...
    typedef typename OperationSmallTranspose< typename EvaluationType::return_Type >::result_Type return_Type;
    ...
    //! Copy constructor
    EvaluationTranspose (const EvaluationTranspose& eval)
        : M_evaluation (eval.M_evaluation)
    {}

    //! Constructor from the corresponding expression
    template< typename Expression>
    explicit EvaluationTranspose (const ExpressionTranspose<Expression>& expression)
    ...
    {
        return M_evaluation.value_q (q).transpose();
    }

    //! Getter for the value for a vector
    return_Type value_qi (const UInt& q, const UInt& i) const
    {
        return M_evaluation.value_qi (q, i).transpose();
    }

    //! Getter for the value for a matrix
    return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
    {
        return M_evaluation.value_qij (q, i, j).transpose();
    }
...
template< typename EvaluationType >
const flag_Type EvaluationTranspose<EvaluationType>::S_globalUpdateFlag
    = EvaluationType::S_globalUpdateFlag;

template< typename EvaluationType >
const flag_Type EvaluationTranspose<EvaluationType>::S_testUpdateFlag
    = EvaluationType::S_testUpdateFlag;

template< typename EvaluationType >
const flag_Type EvaluationTranspose<EvaluationType>::S_solutionUpdateFlag
