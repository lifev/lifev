...
#ifndef EVALUTATION_SAVEVECTORACCORDINGTOFUNCTOR_HPP
#define EVALUTATION_SAVEVECTORACCORDINGTOFUNCTOR_HPP


#include <lifev/core/LifeV.hpp>

#include <lifev/eta/expression/ExpressionSaveVectorAccordingToFunctor.hpp>
...
public:
    ...
    EvaluationFunctor1 (const EvaluationFunctor1<FunctorType, ArgumentEvaluationType>& eval)
        : M_functor (eval.M_functor),
          ...
          M_originVector (eval.M_originVector),
          M_saveVector (eval.M_saveVector),
    {}
    ...
    explicit EvaluationFunctor1 (const ExpressionFunctor1<FunctorType, Argument>& expression)
        : M_functor (expression.functor() ),
          ...
          M_originVector ( expression.originVector() ),
          M_saveVector ( expression.saveVector() )
    {}
