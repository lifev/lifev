...
/*!
 *   @file
     @brief This file contains the definition of the EvaluationSubstraction class.
...
#ifndef EVALUTATION_SUBSTRACTION_HPP
#define EVALUTATION_SUBSTRACTION_HPP

#include <lifev/core/LifeV.hpp>

#include <lifev/eta/array/OperationSmallSubstraction.hpp>
...
public:
	...
	typedef typename OperationSmallSubstraction<Lreturn_Type,Rreturn_Type>::result_Type return_Type;
	...
	explicit EvaluationSubstraction(const ExpressionSubstraction<L,R>& expression)
    ...
    {
        EvaluationLType::display(out); out << " - "; EvaluationRType::display(out);
    }
...
template< typename EvaluationLType, typename EvaluationRType>
const flag_Type EvaluationSubstraction<EvaluationLType,EvaluationRType>::S_globalUpdateFlag
 = EvaluationLType::S_globalUpdateFlag | EvaluationRType::S_globalUpdateFlag;

template< typename EvaluationLType, typename EvaluationRType>
const flag_Type EvaluationSubstraction<EvaluationLType,EvaluationRType>::S_testUpdateFlag
 = EvaluationLType::S_testUpdateFlag | EvaluationRType::S_testUpdateFlag;

template< typename EvaluationLType, typename EvaluationRType>
const flag_Type EvaluationSubstraction<EvaluationLType,EvaluationRType>::S_solutionUpdateFlag
