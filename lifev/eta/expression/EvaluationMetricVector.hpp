...
#ifndef EVALUATION_METRICVECTOR_HPP
#define EVALUATION_METRICVECTOR_HPP
...
public:
    ...
    explicit EvaluationMetricVector (const ExpressionMetricVector& /*expression*/) {}
    ...
    void setGlobalCFE (const CFEType* globalCFE)
    {
        ...
        M_valuePtr = & (globalCFE->M_metricVector);
    }
...
template<UInt spaceDim>
const flag_Type EvaluationMetricVector<spaceDim>::S_globalUpdateFlag = ET_UPDATE_METRIC;

template<UInt spaceDim>
const flag_Type EvaluationMetricVector<spaceDim>::S_testUpdateFlag = ET_UPDATE_NONE;

template<UInt spaceDim>
const flag_Type EvaluationMetricVector<spaceDim>::S_solutionUpdateFlag = ET_UPDATE_NONE;
