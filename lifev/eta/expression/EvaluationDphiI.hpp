...
/*!
 *   @file
     @brief This file contains the definition of the EvaluationDphiI class.

     @date 06/2011
     @author Samuel Quinodoz <samuel.quinodoz@epfl.ch>
 */

#ifndef EVALUATION_DPHI_I_HPP
#define EVALUATION_DPHI_I_HPP
...
//! Evaluation of the basis function dphi_i in the case of a vectorial FE.
/*!
  @author Samuel Quinodoz <samuel.quinodoz@epfl.ch>
