...
operator^(const ExpressionBase<ExpressionDeterminant<ExpressionType> >& l, const Real& r)
{
...
operator^(const ExpressionBase<ExpressionTrace<ExpressionType> >& l, const Real& r)
{
