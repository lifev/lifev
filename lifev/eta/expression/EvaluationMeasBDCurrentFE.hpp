...
#ifndef EVALUATION_MEASUREBDCURRENTFE_HPP
#define EVALUATION_MEASUREBDCURRENTFE_HPP
...
template<UInt spaceDim>
const flag_Type EvaluationMeasBDCurrentFE<spaceDim>::S_globalUpdateFlag = ET_UPDATE_MEASURE;

template<UInt spaceDim>
const flag_Type EvaluationMeasBDCurrentFE<spaceDim>::S_testUpdateFlag = ET_UPDATE_NONE;

template<UInt spaceDim>
const flag_Type EvaluationMeasBDCurrentFE<spaceDim>::S_solutionUpdateFlag = ET_UPDATE_NONE;
