...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Classical way ... " << std::flush;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Integrating g ... " << std::flush;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " Integral error : " << errorIntegralg << std::endl;
    if (verbose) std::cout << " Volume error : " << errorVolume << std::endl;
