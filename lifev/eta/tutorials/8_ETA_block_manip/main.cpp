...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Assembly of the Stokes matrix (I) ... " << std::flush;
    LifeChrono chronoI;
    chronoI.start();
    ...
    *ETsystemMatrixI *=0.0;
    ...
    if (verbose) std::cout << " done! " << std::endl;
    if (verbose) std::cout << " Time: " << chronoI.diff() << std::endl;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Assembly of the Stokes matrix (II) ... " << std::flush;
    LifeChrono chronoII;
    chronoII.start();
    ...
    *ETsystemMatrixII *=0.0;
    ...
    if (verbose) std::cout << " done! " << std::endl;
    if (verbose) std::cout << " Time: " << chronoII.diff() << std::endl;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Assembly of the Stokes matrix (III) ... " << std::flush;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " done! " << std::endl;
    if (verbose) std::cout << " Time: " << chronoIII.diff() << std::endl;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Assembly of the Stokes matrix (IV) ... " << std::flush;
    LifeChrono chronoIV;
    chronoIV.start();
