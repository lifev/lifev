...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Building the rhs via interpolation ... " << std::flush;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Building the rhs via functor ... " << std::flush;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " -- Assembly of the AD-SUPG ... " << std::flush;
...
// ---------------------------------------------------------------
    ...
    if (verbose) std::cout << " done! " << std::endl;
    if (verbose) std::cout << " Rhs diff : " << diffRhsNorm << std::endl;
