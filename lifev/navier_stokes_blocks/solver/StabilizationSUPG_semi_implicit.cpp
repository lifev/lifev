...
void StabilizationSUPG_semi_implicit::apply_matrix( const vector_Type& velocity_previous_newton_step,
...
void StabilizationSUPG_semi_implicit::apply_vector( vectorPtr_Type& residual_velocity,
