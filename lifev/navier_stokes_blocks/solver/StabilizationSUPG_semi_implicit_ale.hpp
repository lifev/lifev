...
#ifndef _STABILIZATIONSUPG_SEMI_IMPLICIT_ALE_HPP_
#define _STABILIZATIONSUPG_SEMI_IMPLICIT_ALE_HPP_ 1
...
class StabilizationSUPG_semi_implicit_ale : public Stabilization
{
public:
    ...
    /*!
        ...
        @param aleVelocity velocity of the domain
     */
...
private:
    ...
    std::shared_ptr<TimeAndExtrapolationHandlerQuadPts<3>> M_handlerFineScaleVelocity;
...
inline StabilizationSUPG_semi_implicit_ale * createStabilizationSUPG_semi_implicit_ale()
{
    return new StabilizationSUPG_semi_implicit_ale();
}
namespace
{
static bool S_registerStabilizationSUPG_semi_implicit_ale = StabilizationFactory::instance().registerProduct ( "SUPG_SEMI_IMPLICIT_ALE",
