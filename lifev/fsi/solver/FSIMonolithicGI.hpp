...
private:
     ...
     */
    void shapeDerivatives ( FSIOperator::fluidPtr_Type::element_type::matrixPtr_Type sdMatrix );
    ...
    FSIOperator::fluidPtr_Type::element_type::matrixPtr_Type M_shapeDerivativesBlock;
