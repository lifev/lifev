...
#ifndef ASSEMBLYPOLICYNAVIERSTOKESSEMIIMPLICIT_HPP
#define ASSEMBLYPOLICYNAVIERSTOKESSEMIIMPLICIT_HPP
...
struct AssemblyPolicyNavierStokesSemiImplicit: public AssemblyPolicyStokes< mesh_Type >
{
...
template< class mesh_Type >
void
AssemblyPolicyNavierStokesSemiImplicit< mesh_Type >::initAssembly ( Teuchos::ParameterList& list )
{
...
template< class mesh_Type >
void
AssemblyPolicyNavierStokesSemiImplicit< mesh_Type >::assembleSystem ( matrixPtr_Type systemMatrix,
                                                                      vectorPtr_Type rhs,
                                                                      vectorPtr_Type solution,
                                                                      preconditionerPtr_Type preconditioner )
{
