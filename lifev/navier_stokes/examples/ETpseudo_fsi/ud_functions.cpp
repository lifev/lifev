...
if(t<=0	  +0.02) return      4.572358	;
if(t<=0.02+0.02) return        4.380298	;
if(t<=0.04+0.02) return        3.971077 ;
if(t<=0.06+0.02) return        3.789365	;
if(t<=0.08+0.02) return        4.394491	;
if(t<=0.1 +0.02) return      6.048268	;
if(t<=0.12+0.02) return        8.463103	;
if(t<=0.14+0.02) return        10.925368;
if(t<=0.16+0.02) return        12.729437;
if(t<=0.18+0.02) return        13.572193;
if(t<=0.2 +0.02) return      13.62635	;
if(t<=0.22+0.02) return        13.300649;
if(t<=0.24+0.02) return        12.900495;
if(t<=0.26+0.02) return        12.473357;
if(t<=0.28+0.02) return        11.895968;
if(t<=0.3 +0.02) return      11.086719	;
if(t<=0.32+0.02) return        10.114592;
if(t<=0.34+0.02) return        9.149018	;
if(t<=0.36+0.02) return        8.307111	;
if(t<=0.38+0.02) return        7.585431	;
if(t<=0.4 +0.02) return      6.924356	;
if(t<=0.42+0.02) return        6.338303	;
if(t<=0.44+0.02) return        5.948785	;
if(t<=0.46+0.02) return        5.880324	;
if(t<=0.48+0.02) return        6.106962	;
if(t<=0.5 +0.02) return      6.41436	;
if(t<=0.52+0.02) return        6.530911	;
if(t<=0.54+0.02) return        6.329742	;
if(t<=0.56+0.02) return        5.911398	;
if(t<=0.58+0.02) return        5.501446	;
if(t<=0.6 +0.02) return      5.253072	;
if(t<=0.62+0.02) return        5.138401	;
if(t<=0.64+0.02) return        5.013553	;
if(t<=0.66+0.02) return        4.78726	;
if(t<=0.68+0.02) return        4.515227	;
if(t<=0.7 +0.02) return      4.341614	;
if(t<=0.72+0.02) return        4.341829	;
if(t<=0.74+0.02) return        4.346171	;
if(t<=0.76+0.02) return        4.460936	;
if(t<=0.78+0.02) return        4.535817	;
if(t<=0.8 +0.02) return      4.485449	;
if(t<=0.82+0.02) return        4.36465	;
if(t<=0.84+0.02) return        4.302813	;
if(t<=0.86+0.02) return        4.363062	;
if(t<=0.88+0.02) return        4.476906	;
if(t<=0.9 +0.02) return      4.51795	;
if(t<=0.92+0.02) return        4.438247	;
if(t<=0.94+0.02) return        4.319594	;
if(t<=0.96+0.02) return        4.286588	;
if(t<=0.98+0.02) return        4.368411	;
if(t<=1	  +0.02) return      4.461585	;
if(t<=1.02+0.02) return        4.439973	;
if(t<=1.04+0.02) return        4.302693	;
if(t<=1.06+0.02) return        4.194866	;
if(t<=1.08+0.02) return        4.260641	;
if(t<=1.1 +0.02) return      4.462993	;
}
