    ...
    namespace
    {
      ...
      namespace utils
      {
        namespace detail
        {
          ...
          template <int id>
          struct shape_id { static const int value = id; };
          
          // type container
          template <typename T>
          struct shape_type { typedef T type; };
        }
      ...
      // ==============
      {
        ...
        else
        {
          ...
          for (std::size_t i = 0; i < num_elms; ++i)
          {
            ...
            for (int k = 0; k < num_tags; ++k) iss >> tmp.tags[k];
            // Fill the values
