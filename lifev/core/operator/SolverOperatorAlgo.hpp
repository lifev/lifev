...
#ifndef _SOLVEROPERATORALGO_HPP_
#define _SOLVEROPERATORALGO_HPP_
 ...
 *
 */
class SolverOperatorAlgo : public LinearOperator
{
public:
...
#else
    SolverOperatorAlgo ( boost::shared_ptr<Epetra_Comm> comm = boost::shared_ptr<Epetra_Comm> ( new Epetra_SerialComm ) );
#endif
...
#endif // _SOLVEROPERATORALGO_HPP_
