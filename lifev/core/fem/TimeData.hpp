...
public:
    ...
    bool canAdvance()
    {
        return round ( M_time ) <= round ( M_endTime );
    }
    ...
    {
        return round ( M_time ) == round ( M_initialTime );
    }
    ...
    bool isLastTimeStep()
    {
        return round ( M_time + M_timeStep ) > round ( M_endTime );
    }
    ...
    {
        M_timeStepNumber = timeStepNumber;
    }
    ...
    {
        return round ( M_time - M_initialTime );
    }
