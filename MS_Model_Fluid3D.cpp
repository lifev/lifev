...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::MS_Model_Fluid3D() \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::SetupData( ) \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::SetupProblem() \n";
#endif

    //Fluid
	M_fluid.reset( new fluid_type(	*M_fluidData,
									*M_uFESpace,
									*M_pFESpace,
									*M_comm,
									imposeFluxes() ) );
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::BuildSystem() \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::UpdateSystem() \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::SolveSystem() \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::setupFEspace() \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::setupDOF \n";
#endif
...
#ifdef DEBUG
	Debug( 8110 ) << "MS_Model_Fluid3D::imposeFluxes \n";
#endif
